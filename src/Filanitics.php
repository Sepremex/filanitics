...
class Filanitics
{
    ...
    public function trajectoryLabel()
    {
        return match ($this->getSign()) {
            -1 => __('filanitics::widgets.trending_down'),
            0 => __('filanitics::widgets.steady'),
            1 => __('filanitics::widgets.trending_up'),
            default => __('filanitics::widgets.steady')
        };
    }
    ...
    {
        return match ($this->getSign()) {
            -1 => config('filanitics.trending_down_color'),
            0 => config('filanitics.trending_steady_color'),
            1 => config('filanitics.trending_up_color'),
            default => config('filanitics.trending_steady_color')
        };
    }
    ...
    {
        return match ($this->getSign()) {
            1 => config('filanitics.trending_up_icon'),
            -1 => config('filanitics.trending_down_icon'),
            default => config('filanitics.steady_icon')
        };
    }
